            ...
            wpp_get_mostpopular([
              ...
              <div>
                <div class="container clearfix">
                  ...
                  <div class="fslider bnews-slider nobottommargin" data-speed="800" data-pause="4000" data-arrows="false" data-pagi="false">
            ...
            <div id="posts">
              ...
              if( have_posts() ){
                while( have_posts() ){
                    ...
                    //content-excerpt.php file loaded
                    get_template_part( 'partials/post/content-excerpt' );

                    // 1)content-excerpt.php if file exists  2)content.php (fallback from wordpress)
                    // get_template_part( 'partials/post/content', 'excerpt' );
                }
              }
