...
<body <?php body_class( 'stretched no-transition' ); ?> itemscope itemtype="http://schema.org/WebPage">
          ...
          <div id="top-social">
            <ul>
              ...
              if( get_theme_mod( 'ju_facebook_handle' ) ){
                ?>
                <li>
                  <a href="<?php echo get_theme_mod( 'ju_facebook_handle' ); ?>" class="si-facebook">
              ...
              if( get_theme_mod( 'ju_twitter_handle' ) ){
                ...
                <li>
                  <a href="<?php echo get_theme_mod( 'ju_twitter_handle' ); ?>" class="si-twitter">
              ...
              if( get_theme_mod( 'ju_instagram_handle' ) ){
                ?>
                <li>
                  <a href="<?php echo get_theme_mod( 'ju_instagram_handle' ); ?>" class="si-instagram">
              ...
              if( get_theme_mod( 'ju_phone_handle' ) ){
                ...
                <li>
                  <a href="tel:<?php echo get_theme_mod( 'ju_phone_handle' ); ?>" class="si-call">
                    ...
                    <span class="ts-text">+<?php echo get_theme_mod( 'ju_phone_handle' ) ?></span>
                  </a>
                </li>
              <?php
              }
              ...
              if( get_theme_mod( 'ju_email_handle' ) ){
                ...
                <li>
                  <a href="mailto:<?php echo get_theme_mod( 'ju_email_handle' ); ?>" class="si-email3">
                    ...
                    <span class="ts-text"><?php echo get_theme_mod( 'ju_email_handle' )?></span>
                  </a>
                </li>
              ...
              ?>
                ...
                <div id="top-cart">
                  <a href="#" id="top-cart-trigger">
                    <i class="icon-shopping-cart"></i><span><?php echo WC()->cart->get_cart_contents_count(); ?></span>
                  </a>
              ...
              ?>
                ...
                <div id="top-search">
                  ...
                  <form action="<?php echo esc_url( home_url( '/' ) ); ?>" method="get">
                    ...
                    placeholder="<?php echo _e( 'Type &amp; Hit Enter..', 'udemy' )?>" 
